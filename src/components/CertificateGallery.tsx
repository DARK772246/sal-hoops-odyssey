...
export const CertificateGallery = () => {
  return (
    <section id="certificates" className="relative w-full bg-background flex items-center justify-center py-20 px-4">
      <div className="container mx-auto text-center">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-muted-foreground mb-12 max-w-2xl mx-auto">
            A collection of my basketball achievements and certificates.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { title: "Certificate of Achievement", img: "/certificates/certificate1.jpg" },
              { title: "MVP Award", img: "/certificates/certificate2.jpg" },
              { title: "Championship Trophy", img: "/certificates/certificate3.jpg" },
